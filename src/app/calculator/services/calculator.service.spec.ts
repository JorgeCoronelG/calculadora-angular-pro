...
describe('CalculatorService', () => {
  ...
  it('should calcualte result correctly for addition', () => {
    service.constructNumber('1');
    service.constructNumber('+');
    service.constructNumber('2');
    service.constructNumber('=');
  ...
  it('should calcualte result correctly for substraction', () => {
  ...
  it('should calcualte result correctly for multiplication', () => {
  ...
  it('should calcualte result correctly for division', () => {
    service.constructNumber('1');
